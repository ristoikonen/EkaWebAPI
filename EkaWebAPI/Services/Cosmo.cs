...
namespace EkaWebAPI.Services
{
    public class Cosmo
    {
        ...
        private static readonly string PrimaryKey = "C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw=="; //Configuration.GetSection("PrimaryKey").Value; 
